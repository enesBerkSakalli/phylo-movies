...
export class UIController {
  ...
  constructor(gui) {
    ...
    this.elements = {
      // Removed: currentTree, numberOfTrees, treeLabel (now handled by SEdgeBarManager)
   ...
   */
  update() {
    const { currentTreeIndex, treeList, transitionResolver, maxScale, scaleList, msaStepSize, msaWindowSize, numberOfFullTrees } = this.gui;
    ...
    // Tree position and type information now handled by SEdgeBarManager
