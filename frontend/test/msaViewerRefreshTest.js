...
describe("MSA Viewer Refresh Tests", function () {
  ...
  beforeEach(function () {
    ...
    // Mock localStorage
    localStorageGetItemStub = sinon
      .stub()
      .callsFake((key) => localStorageData[key] || null);
    ...
    localStorageRemoveItemStub = sinon
      .stub()
  ...
  it("should dispatch custom event when MSA data is saved to localStorage", function () {
    ...
    expect(localStorageSetItemStub.firstCall.args[0]).to.equal(
      "phyloMovieMSAData"
    );
