...
- Name: Phylo-Movies index.html E2E >> should show backend error if /treedata returns error
- Location: /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:44:3
...
Call log:
  - waiting for locator('input[type=file]#trees')
    ...
    at /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:55:21
```
