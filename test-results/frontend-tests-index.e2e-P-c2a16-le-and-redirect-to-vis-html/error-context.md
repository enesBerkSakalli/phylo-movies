...
- Name: Phylo-Movies index.html E2E >> should upload a valid tree file and redirect to vis.html
- Location: /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:30:3
...
Call log:
  - waiting for locator('input[type=file]#trees')
    ...
    at /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:33:21
```
