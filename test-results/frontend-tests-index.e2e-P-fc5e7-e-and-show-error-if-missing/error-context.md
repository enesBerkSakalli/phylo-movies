...
- Name: Phylo-Movies index.html E2E >> should require a tree file and show error if missing
- Location: /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:12:3
...
Locator: locator('#form-alert')
Expected: visible
Received: hidden
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#form-alert')
    9 × locator resolved to <div role="alert" id="form-alert" class="alert d-none"></div>
      - unexpected value "hidden"

    at /Users/berksakalli/Projects/phylo-movies/frontend/tests/index.e2e.spec.ts:26:47
```
