...
(function () {
 ...
 self.max &&*/
  ...
  function P(a, b) {
    ...
    if (d || 0 === d)
      (this.index = d), t(this.g, "z-index", d), d > B && (B = d);
  ...
  function la(a) {
    ...
    F
      ? h(a.g.getElementsByClassName("wb-full")[0], "click", function (b) {
          m(b);
          a.fullscreen().focus();
        })
      : a.addClass("no-full");
  ...
  function V(a, b) {
    function c(g) {
      ...
      a.min ||
        ...
        (p = g.touches) && (p = p[0])
          ? ((g = p), h(window, "touchmove", f, l), h(window, "touchend", d, l))
          : (h(window, "mousemove", f, l), h(window, "mouseup", d, l)),
        (v = g.pageX),
        (L = g.pageY));
    }
    function f(g) {
      ...
      H &&
        ((a.width = Math.max(Math.min(a.width, a.m, J - a.x - a.right), a.s)),
        (H = a.width !== C));
      I &&
        ((a.height = Math.max(
  ...
  e.maximize = function (a) {
    ...
    this.max ||
      (this.addClass("max")
        .resize(J - this.left - this.right, K - this.top - this.bottom, !0)
  ...
  e.move = function (a, b, c) {
    a || 0 === a
      ? c ||
        ((this.x = a ? (a = U(a, J - this.left - this.right, this.width)) : 0),
        (this.y = b ? (b = U(b, K - this.top - this.bottom, this.height)) : 0))
      : ((a = this.x), (b = this.y));
    t(this.g, "left", a + "px");
    t(this.g, "top", b + "px");
