// Colors.js - Consolidated color management for taxa coloring
// Merges ColorMap.js constants and ColorSchemePresets.js palettes
...
export function getColorScheme(name) {
  return COLOR_SCHEMES[name] || Category10;
}

export const ColorSchemePresets = COLOR_SCHEMES;
