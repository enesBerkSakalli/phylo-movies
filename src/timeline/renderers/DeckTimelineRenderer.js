...
import { handleTimelineMouseMoveOrScrub, handleTimelineMouseDown, handleTimelineMouseUp, handleTimelineWheel, handleTimelineMouseLeave } from '@/timeline/events/eventHandlers.js';
import { createPathLayer, createAnchorLayer, createConnectionLayer, createAnchorHoverLayer, createConnectionHoverLayer, createAnchorSelectionLayer, createConnectionSelectionLayer, createSeparatorLayer, createScrubberLayer, getDevicePixelRatio, calculateSeparatorWidth } from '@/timeline/utils/layerFactories.js';
import { msToX, xToMs, calculateZoomScale } from '@/timeline/math/coordinateUtils.js';
import { timeToSegmentIndex } from '@/timeline/utils/searchUtils.js';
import { getTargetSegmentIndex } from '@/timeline/utils/segmentUtils.js';
import { processSegments } from '@/timeline/data/segmentProcessor.js';
