import { PulseAnimationController } from '@/core/treeVisualisation/systems/PulseAnimationController.js';
import { calculatePulseOpacity } from '@/utils/animation/animationUtils.js';
import { TreeColorManager } from '@/core/treeVisualisation/systems/TreeColorManager.js';
import {
  calculateChangePreviews,
  renderTreeControllers,
  toManualMarkedSets,
  toSubtreeSets
} from '@/store/internal/changeTracking.helpers.js';
