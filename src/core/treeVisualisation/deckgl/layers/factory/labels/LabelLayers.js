 ...
 */
import { createLayer } from '@/core/treeVisualisation/deckgl/layers/factory/base/createLayer.js';
import { LAYER_CONFIGS, LAYER_ID_PREFIX } from '@/core/treeVisualisation/deckgl/layers/config/layerConfigs.js';
import {
  SOURCE_LABEL_SCALE,
...
} from '@/core/treeVisualisation/deckgl/layers/config/LabelConfig.js';
...
import {
  ...
  withSideSuffix,
  normalizeTextAnchor
} from '@/core/treeVisualisation/deckgl/layers/styles/labels/labelUtils.js';
