...
import { calculateSafeAreaPadding, normalizeSafeArea } from '@/core/treeVisualisation/spatial/layout.js';
...
export class ViewportManager {
  ...
  updateScreenPositions(nodes, sideOverride = null) {
    ...
    try {
      ...
      const viewport = viewManager.viewports[0];
      ...
      // Suppress noisy startup assertion errors
    }
  }
}
