...
export const MODAL_HEADER_CLASS_NAME = 'flex flex-col gap-2 text-center sm:text-left';

export const MODAL_DESCRIPTION_CLASS_NAME = 'text-sm text-muted-foreground';
