...
export const createSprMovedSubtreeRecurrenceCsv = (
  ...
  const headers = [
    ...
    'Nearest Parent Selected Value Label',
    'Source Nearest Parent Selected Value Median',
    'Target Nearest Parent Selected Value Median',
    'Low Nearest Parent Selected Value Moves',
    'Missing Nearest Parent Selected Value Moves',
...
export const createSprMoveEventCsv = (
  ...
  const headers = [
    ...
    'Source Nearest Parent Selected Value',
    'Target Nearest Parent Selected Value',
    'Selected Branch Value Label',
    'Moved Subtree Value Class',
    'Nearest Parent Selected Value Class',
    'Step Range',
    'RF Distance',
