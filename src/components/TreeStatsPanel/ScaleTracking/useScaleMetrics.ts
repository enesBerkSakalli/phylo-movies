...
import {
  ...
  buildHistogram,
  clamp
} from '@/components/TreeStatsPanel/Shared/utils';
import type { ScaleMetrics, TreeNode, ScaleListItem, TransitionResolver } from '@/components/TreeStatsPanel/Shared/types';
