      ...
      <main className="pb-8">
        ...
        <div className="container mx-auto max-w-4xl space-y-8 px-4 sm:px-6 lg:px-8">
          ...
          <Card className="shadow-lg border-muted">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              ...
              <div className="rounded-lg border bg-muted p-4 text-xs leading-relaxed text-foreground">
                ...
                , version 0.98.2. Zenodo. doi:10.5281/zenodo.20488923
              </div>
              <div className="flex flex-wrap gap-3 pt-2">
                <Button asChild>
                  <a href={PREPRINT_URL} target="_blank" rel="noopener noreferrer">
          ...
          <Card className="shadow-lg border-muted">
            ...
            <CardContent className="space-y-3 text-sm text-muted-foreground">
              <p>
                The full application combines a React frontend with the BranchArchitect Python
                backend for interpolation and MSA-based processing.
              </p>
              <p>
