...
const { parseMSA, parseFasta, parseClustal, parsePhylip } = require('../frontend/js/msaViewer/parsers.js');
...
describe('File Upload and Parsing Tests', () => {
  ...
  describe('FASTA File Tests', () => {
    ...
    it('should parse FASTA content correctly', () => {
      ...
      expect(ids).to.include.members(['A1', 'A2', 'B1', 'B2', 'X', 'C1', 'C2', 'D1', 'D2', 'O1', 'O2']);
    });
  });
