...
// const { parseFasta, parseNewick } = require('../frontend/js/parsers');
...
describe('Parser Tests', () => {
  ...
  describe('FASTA Parser', () => {
    ...
    it('should extract correct sequence IDs', () => {
      ...
      expect(ids).to.have.members(['A1', 'A2', 'B1', 'B2', 'X', 'C1', 'C2', 'D1', 'D2', 'O1', 'O2']);
    });
    ...
    it('should handle edge cases', () => {
      ...
      expect(parseFasta('>seq1\nACGT')).to.deep.equal([{ id: 'seq1', sequence: 'ACGT' }]);
    });
  });
  ...
  describe('Newick Parser', () => {
    ...
    it('should include branch lengths', () => {
      ...
      trees.forEach(tree => {
        ['A1:', 'A2:', 'B1:', 'B2:', 'X:', 'C1:', 'C2:', 'D1:', 'D2:', 'O1:', 'O2:'].forEach(taxon => {
