...
async function testImports() {
  try {
    const { createSideBySideComparisonModal, createInterpolationModal } = await import('../frontend/js/treeComparision/treeComparision.js');
    console.log('✓ treeComparision.js imports work');
    
    const { TreeSelectionService } = await import('../frontend/js/space/TreeSelectionService.js');
    console.log('✓ TreeSelectionService.js import works');
    
    const { ComparisonModal } = await import('../frontend/js/treeComparision/ComparisonModal.js');
    console.log('✓ ComparisonModal.js import works');
    
    const { InterpolationModal } = await import('../frontend/js/treeComparision/InterpolationModal.js');
